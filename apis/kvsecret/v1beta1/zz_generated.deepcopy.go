...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KVSecretObservation) DeepCopyInto(out *KVSecretObservation) {
	*out = *in
	if in.Data != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KVSecretObservation.
func (in *KVSecretObservation) DeepCopy() *KVSecretObservation {
	if in == nil {
		return nil
	}
	out := new(KVSecretObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KVSecretParameters) DeepCopyInto(out *KVSecretParameters) {
	*out = *in
	if in.Data != nil {
		in, out := &in.Data, &out.Data
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KVSecretParameters.
func (in *KVSecretParameters) DeepCopy() *KVSecretParameters {
	if in == nil {
		return nil
	}
	out := new(KVSecretParameters)
	in.DeepCopyInto(out)
	return out
}
